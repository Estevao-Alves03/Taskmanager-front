...
function BarraDeTarefas({total, concluidas}: Props) {

    const progresso = (concluidas / total) * 100;

  return (
      <div className='mr-72 ml-72 bg-white pt-7 p-4 rounded'>
        <div className='flex justify-between items-center mb-2'>
          ...
          <Button className='bg-emerald-600 text-white px-6 py-6 rounded hover:bg-emerald-700 text-xl flex items-center gap-2'>
            <MdAdd/> Nova Tarefa
          </Button>
        </div>
